...
export const ServiceItem1 = ({
  ...
  return (
    <Pressable
      className={`flex flex-row relative bg-background-50 rounded-xl justify-between p-3 h-28 flex-1`}
    >
      {promo && (
...
export const ServiceItem2 = ({
  ...
  return (
    <Pressable
      className={`items-center p-3 bg-background-50 rounded-xl flex-1 h-32`}
    >
